...
public class EventsManagerDetailsFragment extends qA {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.toolbar.setTitle("جزئیات رویداد");
    ...
    public class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            if ("".equals(dataArray.get(position).get("var"))) {
                holder.binding.eventSubtitle.setText("رویداد اکتیویتی");
            } else {
            ...
            holder.itemView.setOnLongClickListener(v -> {
                new MaterialAlertDialogBuilder(requireContext())
                        ...
                        .setMessage("این رویداد حذف شود؟")
                        .setPositiveButton("حذف", (dialog, i) -> deleteItem(position))
                        .setNeutralButton("ویرایش", (dialog, i) -> {
                            Bundle args = new Bundle();
                            args.putString("lis_name", listName);
                            args.putString("event", (String) dataArray.get(position).get("name"));
                            args.putString("_pos", String.valueOf(position));
                        ...
                        .setNegativeButton("لغو", (di, i) -> di.dismiss())
                        .show();
                return true;
            });
        }
